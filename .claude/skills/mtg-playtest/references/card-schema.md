...
<!-- toc -->
- [目的と原則](#目的と原則)
- [保存場所とファイル名](#保存場所とファイル名)
- [レコードのスキーマ](#レコードのスキーマ)
- [導出規則](#導出規則)
- [名前の解決（表記揺れ）](#名前の解決表記揺れ)
- [source と unresolved](#source-と-unresolved)
- [別名レコード（mtg-playtest/alias@1）](#別名レコードmtg-playtestalias1)
- [日英対応表](#日英対応表)
- [書き込み規則](#書き込み規則)
- [検証](#検証)
- [参照時の解決順](#参照時の解決順)
